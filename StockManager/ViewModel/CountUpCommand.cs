...
namespace StockManager
{
    ...
    public class DelegateCommand<PageViewModel> : ICommand
    {

        private readonly Action<PageViewModel> _execute;
        ...
        public DelegateCommand(Action<PageViewModel> execute) : this(execute, () => true) { }

        public DelegateCommand(Action<PageViewModel> execute, Func<bool> canExecute)
        {
        ...
        public void Execute(object parameter)
        {
            this._execute((PageViewModel)parameter);
        }
